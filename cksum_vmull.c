...
bool cksum_vmull(FILE *fp, uint_fast32_t *crc_out, uintmax_t *length_out) {
  ...
  /* These constants and general algorithms are taken from the Intel whitepaper
     ...
     */
  single_mult_constant = vcombine_p64(vcreate_p64(0xe8a45605),
                                      vcreate_p64(0xc5b9cd4c));

  four_mult_constant   = vcombine_p64(vcreate_p64(0xe6228b11),
  ...
  while ((bytes_read = fread(buf, 1, BUFLEN, fp)) > 0) {
    ...
    if (bytes_read >= 16 * 8) {
      ...
      while (bytes_read >= 16 * 8) {
        ...
        data2 = vreinterpretq_u64_p128(
                      vmull_p64(vgetq_lane_p64(vreinterpretq_p64_u64(data ), 0),
                                vgetq_lane_p64(four_mult_constant, 0)));
        data  = vreinterpretq_u64_p128(
                      vmull_high_p64(vreinterpretq_p64_u64(data),
                                     four_mult_constant));
        data4 = vreinterpretq_u64_p128(
                      vmull_p64(vgetq_lane_p64(vreinterpretq_p64_u64(data3), 0),
                                vgetq_lane_p64(four_mult_constant, 0)));
        data3 = vreinterpretq_u64_p128(
                      vmull_high_p64(vreinterpretq_p64_u64(data3),
                                     four_mult_constant));
        data6 = vreinterpretq_u64_p128(
                      vmull_p64(vgetq_lane_p64(vreinterpretq_p64_u64(data5), 0),
                                vgetq_lane_p64(four_mult_constant, 0)));
        data5 = vreinterpretq_u64_p128(
                      vmull_high_p64(vreinterpretq_p64_u64(data5),
                                     four_mult_constant));
        data8 = vreinterpretq_u64_p128(
                      vmull_p64(vgetq_lane_p64(vreinterpretq_p64_u64(data7), 0),
                                vgetq_lane_p64(four_mult_constant, 0)));
        data7 = vreinterpretq_u64_p128(
                      vmull_high_p64(vreinterpretq_p64_u64(data7),
                                     four_mult_constant));
    ...
    if (bytes_read >= 32) {
      ...
      while (bytes_read >= 32) {
        ...
        data2 = vreinterpretq_u64_p128(
                      vmull_p64(vgetq_lane_p64(vreinterpretq_p64_u64(data), 0),
                      vgetq_lane_p64(single_mult_constant, 0)));
        data  = vreinterpretq_u64_p128(
                      vmull_high_p64(vreinterpretq_p64_u64(data),
